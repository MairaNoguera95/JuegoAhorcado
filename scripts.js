document.addEventListener('DOMContentLoaded', function () {
    ...
    // VARIABLES
    //=====================================================================
    const listaPalabras = ['flores', 'sillas', 'caballo', 'juegos', 'fiesta',];
    let palabraAdivinar = [];
    let palabraMostrar = [];
    let historialUsuarioLetras = [];
    let numIntentos = 6;
    ...
    function dibujarJuego () {
        ...
        nodoHistorial.textContent = historialUsuarioLetras.join(' ');
    }
    /**
    ...
    function comprobarLetraUsuario () {
        ...
        //// 2 comprobar si el usuario se ha eqquivocado
        // ¿No esta la letra?
        if (!palabraAdivinar.includes(letraUsuario)) {
            ...
            document.getElementById("image"+numIntentos).className += "fade-in";
            // Guardamos en el historial la letra pulsada por el usuario
            historialUsuarioLetras.push(letraUsuario);
        }
